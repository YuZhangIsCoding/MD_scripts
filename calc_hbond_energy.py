...
plt.annotate('%.3f nm, %.2f kT' %pos, xy = pos, xytext = (0.25, -4), arrowprops = dict(arrowstyle="->", edgecolor = 'black', connectionstyle="arc3", shrinkB = 8), ha = 'center', va = 'bottom')
