...
hdist = np.loadtxt('hbond_ha_dist_ho.txt')
...
plt.annotate('%.3f nm, %.2f kT' %pos, xy = pos, xytext = (0.27, 30), arrowprops = dict(arrowstyle="->", edgecolor = 'black', connectionstyle="arc3", shrinkB = 8), ha = 'center', va = 'bottom')
...
plt.savefig('Hbonds_energy_ho.pdf')
