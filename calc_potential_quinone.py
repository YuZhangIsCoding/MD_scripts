...
parser.add_argument('-c', '--config', dest = 'config', choices = ['Q', 'H2Q', 'QH2Q'], help = 'Configuration of quinone')
...
if args.exb == None:
    if args.config == 'Q':
        ...
        exb_1 = 0
        exb_2 = 0.384
    elif args.config == 'QH2Q':
        exb_1 = 0
        exb_2 = 0.437
    else:
        sys.exit('Exit: please specify the configuration (Q, H2Q, QH2Q)')
else:
    exb_1 = args.exb[0]
    exb_2 = args.exb[1]
