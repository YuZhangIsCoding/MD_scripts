...
#               The input data has already translated according to pzc like following:
#               0.01 ... ...
#               0.02 ... ...
...
sigma = np.concatenate((-data[:, 0][::-1], [0], data[:, 0]))
pot = np.concatenate((data[:,2][::-1], [0], data[:, 1]))
...
#    print 100*(f(args.pot[1])-f(args.pot[0]))
